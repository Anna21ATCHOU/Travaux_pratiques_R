...
@author: ATCHOU Amavi & Sié Rachid TRAORE
"""
############################## Partie I: ########################################################################
...
online_rt=pd.read_csv("C:\\Users\\HP\\Documents\\ISE_1_Eco\\algorithme et programmation\\tp_python-3\\tp_python-3\\vente_detail.csv", encoding='latin1')
...
for country in top_countries:
    ...
    plt.title('Quantity vs UnitPrice by CustomerID for Top 3 Countries (excluding UK)')
